...
💰 **Harga: $62,146**
📈 24h: -2.33% | 7d: +3.35% | 30d: -2.02%
📊 24h Range: $61,550 - $63,823
💎 ATH: $126,080 (-50.7% dari ATH)
🏦 Market Cap: $1,246.3B
💹 Volume 24h: $28.9B
...
1. **BTC anjlok ke $62K setelah trader futures potong risiko jelang keputusan Fed** — Cointelegraph
2. **Iran ceasefire collapse & ancaman blokade Hormuz tekan kripto dan saham** — CoinDesk / Cointelegraph
3. **Harga minyak naik ke $75 karena ketegangan Timur Tengah baru, inflasi makin sticky** — CoinDesk
4. **Trump nyatakan ceasefire 'over' setelah serangan Iran — crypto & saham jatuh** — CoinDesk
5. **Analisis: 'Textbook Bitcoin bottom' sedang berlangsung, spekulator jadi fokus** — Cointelegraph
6. **Adam Back's BSTR (Bitcoin treasury co) batal merger SPAC, cari deal baru** — CoinDesk / Cointelegraph
7. **SpaceX wallet movement pertama dalam 6 bulan — kemungkinan bukan sinyal jual** — CoinDesk
8. **Kazakhstan tanda tangan dekret percepat adopsi kripto** — Cointelegraph

---

🐋 **Whale & ETF:**
- SpaceX wallet bergerak pertama kali dalam 6 bulan, tapi analis CoinDesk bilang ini kemungkinan **bukan sinyal penjualan**.
- Tidak ada data ETF inflow/outflow terbaru yang berhasil di-fetch dari API (Brave Search down). Pergerakan trader futures yang agresif memotong posisi jelang Fed jadi sinyal bearish jangka pendek.

---

⚖️ **Regulasi:**
- Kazakhstan resmi mempercepat adopsi kripto via dekret presiden.
- India: filing pajak kripto masih tertinggal jauh dari aktivitas trading.
- Bank of England governor bantah lobi Farage pengaruhi kebijakan CBDC.

---

🔮 **Signal: BEARISH (jangka pendek) / MIXED (jangka menengah)**

Kombinasi ketegangan geopolitik Iran-Hormuz yang memicu kenaikan harga minyak + inflasi sticky + trader futures defensif jelang Fed = tekanan jual masih dominan. Harga turun 2.33% dalam 24h dan anjlok 50% dari ATH. Namun, analis mulai melihat pola "textbook bottom" di level ini, dan Fear & Greed di 20 (Extreme Fear) secara historis sering jadi contrarian buy signal. **Tunggu konfirmasi reversal sebelum masuk — level kunci support ~$61,500, resistance ~$63,800.**
