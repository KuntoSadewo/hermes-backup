...
💰 **Harga: $63,830**
📈 **24h: +3.05%** | 7d: +4.02% | 30d: +4.14%
📊 **24h Range:** $61,883 - $63,927
...
1. **Billions mengalir keluar dari Bitcoin ETF & private credit funds** — indikator risiko pasar yang meningkat — CoinDesk
2. **Trader pantau level kunci $62K** jelang options expiry $1.4 miliar hari Jumat — Cointelegraph
3. **Harga BTC tembus $63K** setelah komentar Trump soal "deal" dengan Iran — Cointelegraph
4. **Miner BTC pivot ke AI** — investor soroti insider sales di Cipher & TeraWulf — CoinDesk/Cointelegraph
5. **Clarity Act versi baru** bisa rilis minggu depan, tapi belum ada bipartisan buy-in — CoinDesk
6. **MARA +14%** setelah deal infrastruktur 2 GW di Texas untuk ekspansi AI — Cointelegraph
7. **Bitdeer +14%** ekspansi produksi mining hardware di AS — Cointelegraph
8. **New Hampshire tolak proyek government bitcoin bond** 3-2 — CoinDesk

---

🐋 **Whale & ETF:**
- **ETF outflows signifikan** — dana besar keluar dari Bitcoin ETF, sinyal tekanan jual institusional
- Options expiry $1.4B hari Jumat → potensi volatilitas tinggi, pantau level $62K sebagai support kritis

⚖️ **Regulasi:**
- **Crypto Clarity Act** draft baru mungkin minggu depan — langkah positif untuk market structure, tapi belum bipartisan
- White House belum dapat respons dari Demokrat terkait kekosongan posisi SEC & CFTC

---

🔮 **Signal: MIXED (Cenderung Bearish Jangka Pendek)**

BTC bounce +3% dalam 24h, tapi Fear & Greed di 23 (**Extreme Fear**) menunjukkan sentimen pasar masih sangat negatif. ETF outflows terus berlanjut dan options expiry besar hari Jumat bisa trigger volatilitas dua arah. Komentar Trump soal Iran deal beri dorongan singkat, tapi fundamental jangka pendek masih tertekan — BTC masih 49% dari ATH. **Pantau $62K sebagai support; break di bawah → potensi test $58-60K.**
