...
1. **Bitcoin's dwindling exchange reserves don't pack the same bullish punch anymore** — CoinDesk
2. **Bitcoin, ether steady, gold slides as U.S.-Iran tensions escalate again** — CoinDesk
3. **Live markets: Second day of U.S.-Iran conflict keeps markets volatile as oil drops** — CoinDesk
4. **Bank of Japan may speed up rate hikes, pushing borrowing costs above 2%** — CoinDesk
5. **Crypto Long & Short: With MSTR concerns assuaged, look to traditional signals around BTC** — CoinDesk
6. **'CASHCAT' trader turns $800 into $1M on Robinhood's brand new blockchain** — CoinDesk

---

🐋 **On-Chain & Exchange:**

- **Top Exchange Volume (24h):** Binance 18,134 BTC | OKX 15,742 BTC | DigiFinex 10,664 BTC
- **Exchange reserves menurun** — tapi CoinDesk catat efek bullish-nya sudah tidak sekuat dulu karena perubahan struktur pasar (ETF mengambil alih peran exchange sebagai sumber likuiditas utama)
- **Hash Rate:** 852 EH/s — jaringan tetap sangat kuat
- **Mempool Fees:** 1 sat/vB — aktivitas on-chain rendah, belum ada tekanan transaksi

---

🌍 **Makro & Geopolitik:**

- **U.S.-Iran tensions escalation** hari kedua — pasar volatil, oil turun
- **BOJ signal rate hike** — potensi penguatan yen & dampak ke carry trade global
- **MSTR (MicroStrategy)** — kekhawatiran reda setelah laporan terbaru, market mulai fokus ke sinyal tradisional untuk BTC

---

🔮 **Signal: MIXED (cenderung cautious-bullish)**

Fear & Greed di 22 (Extreme Fear) tapi harga naik +4.57% dalam 7 hari — ini bisa jadi **contrarian bullish setup**. Konflik U.S.-Iran bikin pasar gelisah, tapi BTC relatif stabil di atas $61k. Hash rate tinggi & exchange reserve turun = supply squeeze masih ada, tapi volume on-chain dan fee sangat rendah menunjukkan belum ada partisipasi besar dari retail. **Watch $63k sebagai resistance kunci** — breakout di atas bisa trigger momentum ke $65-66k.
