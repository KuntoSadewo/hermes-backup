...
| `references/x-actions.md` | X/Twitter controlled automation integration notes, cookie/env setup, mobile DevTools pitfalls. |
...
| `references/x-actions-session.md` | Notes for using `Aripin171103/x-actions` safely: setup, cookies, side-effect confirmation, known script pitfall. |
